 ...
 */
export const getQuickstartScript = <ThrowOnError extends boolean = false>(options?: Options<GetQuickstartScriptData, ThrowOnError>) => (options?.client ?? client).get<GetQuickstartScriptResponses, unknown, ThrowOnError>({ url: '/quickstart', ...options });
 ...
 * <span>💰 <strong>Cost:</strong> FREE! No credits are charged for this API.&nbsp;<span title="Pricing shown is default pricing. Actual pricing may vary.">ⓘ</span></span>
 */
export const cardsAttach = <ThrowOnError extends boolean = false>(options: Options<CardsAttachData, ThrowOnError>) => (options.client ?? client).post<CardsAttachResponses, CardsAttachErrors, ThrowOnError>({
    url: '/v1/cards/attach',
    ...options,
    headers: {
        'Content-Type': 'application/json',
 ...
 * <span>💰 <strong>Cost:</strong> FREE! No credits are charged for this API.&nbsp;<span title="Pricing shown is default pricing. Actual pricing may vary.">ⓘ</span></span>
 */
export const getAllApiKeys = <ThrowOnError extends boolean = false>(options: Options<GetAllApiKeysData, ThrowOnError>) => (options.client ?? client).post<GetAllApiKeysResponses, GetAllApiKeysErrors, ThrowOnError>({
    url: '/v1/api-keys',
    ...options,
    headers: {
        'Content-Type': 'application/json',
 ...
 * <span>💰 <strong>Cost:</strong> FREE! No credits are charged for this API.&nbsp;<span title="Pricing shown is default pricing. Actual pricing may vary.">ⓘ</span></span>
 */
export const getCurrentApiKey = <ThrowOnError extends boolean = false>(options: Options<GetCurrentApiKeyData, ThrowOnError>) => (options.client ?? client).post<GetCurrentApiKeyResponses, GetCurrentApiKeyErrors, ThrowOnError>({
 ...
 *
 * Change the expiration of an API key. Acts on the key that authenticates this request unless target is OTHER. Choose set to pin an absolute date, extend or prepone to move the date by a number of days, or remove to make the key never expire. Once a key expires it can no longer authenticate. First-time users: create your initial API key at https://app.fiber.ai or via POST /v1/account/send-otp + verify-otp. This endpoint manages keys once you have one.
 *
 * <span>⚡ <strong>Rate limit:</strong> 30 requests per 1 minute</span>
 *
 * <span>💰 <strong>Cost:</strong> FREE! No credits are charged for this API.&nbsp;<span title="Pricing shown is default pricing. Actual pricing may vary.">ⓘ</span></span>
 */
export const updateApiKeyExpiration = <ThrowOnError extends boolean = false>(options: Options<UpdateApiKeyExpirationData, ThrowOnError>) => (options.client ?? client).post<UpdateApiKeyExpirationResponses, UpdateApiKeyExpirationErrors, ThrowOnError>({
 ...
 * <span>💰 <strong>Cost:</strong> FREE! No credits are charged for this API.&nbsp;<span title="Pricing shown is default pricing. Actual pricing may vary.">ⓘ</span></span>
 */
export const revokeCurrentApiKey = <ThrowOnError extends boolean = false>(options: Options<RevokeCurrentApiKeyData, ThrowOnError>) => (options.client ?? client).post<RevokeCurrentApiKeyResponses, RevokeCurrentApiKeyErrors, ThrowOnError>({
 ...
 * <span>💰 <strong>Cost:</strong> FREE! No credits are charged for this API.&nbsp;<span title="Pricing shown is default pricing. Actual pricing may vary.">ⓘ</span></span>
 */
export const updateApiKeyLimit = <ThrowOnError extends boolean = false>(options: Options<UpdateApiKeyLimitData, ThrowOnError>) => (options.client ?? client).post<UpdateApiKeyLimitResponses, UpdateApiKeyLimitErrors, ThrowOnError>({
 ...
 * <span>💰 <strong>Cost:</strong> FREE! No credits are charged for this API.&nbsp;<span title="Pricing shown is default pricing. Actual pricing may vary.">ⓘ</span></span>
 */
export const resetApiKeyUsage = <ThrowOnError extends boolean = false>(options: Options<ResetApiKeyUsageData, ThrowOnError>) => (options.client ?? client).post<ResetApiKeyUsageResponses, ResetApiKeyUsageErrors, ThrowOnError>({
    url: '/v1/api-keys/usage/reset',
    ...options,
    headers: {
        'Content-Type': 'application/json',
        ...options.headers
 ...
 * <span>💰 <strong>Cost:</strong> FREE! No credits are charged for this API.&nbsp;<span title="Pricing shown is default pricing. Actual pricing may vary.">ⓘ</span></span>
 */
export const createSandboxApiKey = <ThrowOnError extends boolean = false>(options: Options<CreateSandboxApiKeyData, ThrowOnError>) => (options.client ?? client).post<CreateSandboxApiKeyResponses, CreateSandboxApiKeyErrors, ThrowOnError>({
 ...
 * <span>💰 <strong>Cost:</strong> FREE! No credits are charged for this API.&nbsp;<span title="Pricing shown is default pricing. Actual pricing may vary.">ⓘ</span></span>
 */
export const listApiRequests = <ThrowOnError extends boolean = false>(options: Options<ListApiRequestsData, ThrowOnError>) => (options.client ?? client).post<ListApiRequestsResponses, ListApiRequestsErrors, ThrowOnError>({
    url: '/v1/api-requests',
    ...options,
    headers: {
        'Content-Type': 'application/json',
 ...
 * <span>💰 <strong>Cost:</strong> FREE! No credits are charged for this API.&nbsp;<span title="Pricing shown is default pricing. Actual pricing may vary.">ⓘ</span></span>
 */
export const accountSendOtp = <ThrowOnError extends boolean = false>(options: Options<AccountSendOtpData, ThrowOnError>) => (options.client ?? client).post<AccountSendOtpResponses, AccountSendOtpErrors, ThrowOnError>({
 ...
 * <span>💰 <strong>Cost:</strong> FREE! No credits are charged for this API.&nbsp;<span title="Pricing shown is default pricing. Actual pricing may vary.">ⓘ</span></span>
 */
export const accountVerifyOtp = <ThrowOnError extends boolean = false>(options: Options<AccountVerifyOtpData, ThrowOnError>) => (options.client ?? client).post<AccountVerifyOtpResponses, AccountVerifyOtpErrors, ThrowOnError>({
 ...
 *
 * <span>💰 <strong>Cost:</strong> 1 credit per company found, plus 1 credit when includeCount=true&nbsp;<span title="Pricing shown is default pricing. Actual pricing may vary. Count credits only apply when the includeCount flag is set.">ⓘ</span></span>
 */
 ...
 * <span>⚡ <strong>Rate limit:</strong> 180 requests per 1 minute</span>
 *
 * <span>💰 <strong>Cost:</strong> 1 credit per profile found, plus 1 credit when includeCount=true&nbsp;<span title="Pricing shown is default pricing. Actual pricing may vary. Count credits only apply when the includeCount flag is set.">ⓘ</span></span>
 */
 ...
 *
 * <span>💰 <strong>Cost:</strong> 1 credit per company resolved&nbsp;<span title="Pricing shown is default pricing. Actual pricing may vary.">ⓘ</span></span>
 */
export const quickCompanyResolve = <ThrowOnError extends boolean = false>(options: Options<QuickCompanyResolveData, ThrowOnError>) => (options.client ?? client).post<QuickCompanyResolveResponses, QuickCompanyResolveErrors, ThrowOnError>({
 ...
 * <span>⚡ <strong>Rate limit:</strong> 1500 requests per 1 minute</span>
 *
 * <span>💰 <strong>Cost:</strong> 1 credit per person resolved&nbsp;<span title="Pricing shown is default pricing. Actual pricing may vary.">ⓘ</span></span>
 */
export const quickPersonResolve = <ThrowOnError extends boolean = false>(options: Options<QuickPersonResolveData, ThrowOnError>) => (options.client ?? client).post<QuickPersonResolveResponses, QuickPersonResolveErrors, ThrowOnError>({
 ...
 * <span>⚡ <strong>Rate limit:</strong> 600 requests per 1 minute</span>
 *
 * <span>💰 <strong>Cost:</strong> 1 credit per company returned&nbsp;<span title="Pricing shown is default pricing. Actual pricing may vary.">ⓘ</span></span>
 */
export const listCompanyRankings = <ThrowOnError extends boolean = false>(options: Options<ListCompanyRankingsData, ThrowOnError>) => (options.client ?? client).post<ListCompanyRankingsResponses, ListCompanyRankingsErrors, ThrowOnError>({
 ...
 */
export const instantContactReveal = <ThrowOnError extends boolean = false>(options: Options<InstantContactRevealData, ThrowOnError>) => (options.client ?? client).post<InstantContactRevealResponses, InstantContactRevealErrors, ThrowOnError>({
 ...
 * <span>⏱ <strong>Recommended timeout:</strong> 1 minute&nbsp;<span title="Recommended timeout: set your HTTP client timeout to at least 1 minute for this endpoint.">ⓘ</span></span>
 */
export const getDepartmentSize = <ThrowOnError extends boolean = false>(options: Options<GetDepartmentSizeData, ThrowOnError>) => (options.client ?? client).post<GetDepartmentSizeResponses, GetDepartmentSizeErrors, ThrowOnError>({
 ...
 * <span>⏱ <strong>Recommended timeout:</strong> 2 minutes&nbsp;<span title="Recommended timeout: set your HTTP client timeout to at least 2 minutes for this endpoint.">ⓘ</span></span>
 */
export const getTalentFlow = <ThrowOnError extends boolean = false>(options: Options<GetTalentFlowData, ThrowOnError>) => (options.client ?? client).post<GetTalentFlowResponses, GetTalentFlowErrors, ThrowOnError>({
    url: '/v1/talent-flow',
    ...options,
    headers: {
        'Content-Type': 'application/json',
 ...
 */
export const getTalentFlowRivals = <ThrowOnError extends boolean = false>(options: Options<GetTalentFlowRivalsData, ThrowOnError>) => (options.client ?? client).post<GetTalentFlowRivalsResponses, GetTalentFlowRivalsErrors, ThrowOnError>({
 ...
 *
 * Searches Yelp for businesses matching a query in a location, and returns matching businesses with ratings, review counts, and contact details.
 *
 * <span>⚡ <strong>Rate limit:</strong> 120 requests per 1 minute</span>
 *
 * <span>💰 <strong>Cost:</strong> 2 credits per search&nbsp;<span title="Pricing shown is default pricing. Actual pricing may vary.">ⓘ</span></span>
 */
export const yelpSearch = <ThrowOnError extends boolean = false>(options: Options<YelpSearchData, ThrowOnError>) => (options.client ?? client).post<YelpSearchResponses, YelpSearchErrors, ThrowOnError>({
    url: '/v1/yelp/search',
    ...options,
    headers: {
        'Content-Type': 'application/json',
 ...
 * <span>⚡ <strong>Rate limit:</strong> 120 requests per 1 minute</span>
 *
 * <span>💰 <strong>Cost:</strong> 2 credits per business page&nbsp;<span title="Pricing shown is default pricing. Actual pricing may vary.">ⓘ</span></span>
 */
export const yelpPlace = <ThrowOnError extends boolean = false>(options: Options<YelpPlaceData, ThrowOnError>) => (options.client ?? client).post<YelpPlaceResponses, YelpPlaceErrors, ThrowOnError>({
    url: '/v1/yelp/place',
    ...options,
    headers: {
        'Content-Type': 'application/json',
 ...
 *
 * Get reviews of a Yelp business, paginated, with reviewer details, ratings, and full review text. Obtain the business ID via the /yelp/search endpoint.
 *
 * <span>⚡ <strong>Rate limit:</strong> 120 requests per 1 minute</span>
 *
 * <span>💰 <strong>Cost:</strong> 2 credits per reviews page&nbsp;<span title="Pricing shown is default pricing. Actual pricing may vary.">ⓘ</span></span>
 */
export const yelpReviews = <ThrowOnError extends boolean = false>(options: Options<YelpReviewsData, ThrowOnError>) => (options.client ?? client).post<YelpReviewsResponses, YelpReviewsErrors, ThrowOnError>({
    url: '/v1/yelp/reviews',
    ...options,
    headers: {
        'Content-Type': 'application/json',
 ...
 */
export const financialInstrumentLookup = <ThrowOnError extends boolean = false>(options: Options<FinancialInstrumentLookupData, ThrowOnError>) => (options.client ?? client).post<FinancialInstrumentLookupResponses, FinancialInstrumentLookupErrors, ThrowOnError>({
